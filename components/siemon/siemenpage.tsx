...
export default function SiemensPage() {
  return (
    <main data-brand='siemens' className='bg-wash text-[#111827]'>
              ...
              >
                ...
                <div className='p-6'>
                  <div className='mb-5 flex items-center gap-4'>
                    <div className='flex h-12 w-12 items-center justify-center rounded-xl bg-[#ECFAF8] text-btn-deep'>
            ...
            {videoCards.map((video) => (
              ...
              >
                ...
                <div className='space-y-4 p-5'>
                  <span className='inline-flex rounded-full bg-[#ECFAF8] px-3 py-1 text-sm font-semibold text-btn-deep'>
                    {video.category}
                  </span>
        ...
        <div className='mx-auto max-w-[1400px] px-6 md:px-8 lg:px-10'>
          <div className='rounded-[28px] bg-[#F5F6F7] p-8 shadow-[0_10px_30px_rgba(0,0,0,0.06)] md:p-10'>
            <div className='flex items-start gap-3'>
              <div className='mt-1 flex h-9 w-9 items-center justify-center rounded-full bg-[#ECFAF8] text-btn-deep'>
