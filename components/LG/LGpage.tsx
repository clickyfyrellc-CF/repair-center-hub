...
const serviceCards: ServiceCard[] = [
  {
    ...
    icon: 'refrigerator',
    description:
      'Expert refrigerator repair services for all LG models. From cooling issues to ice maker problems, we handle it all.',
    issues: [
  ...
  },
  {
    ...
    icon: 'washing',
    description:
      'Professional washing machine repair for LG front-load and top-load models with same-day service.',
    issues: [
      "Won't spin or drain",
  ...
  },
  {
    ...
    icon: 'oven',
    description:
      'Expert oven repair for all LG electric and gas ovens including temperature calibration and heating element replacement.',
    issues: [
  ...
  },
  {
    ...
    icon: 'dryer',
    description:
      'Professional dryer repair services for heat pump and condenser models with quality LG parts.',
    issues: [
      'Not heating',
      ...
      <section className='bg-[#f7f8fa] py-16 md:py-20'>
        <div className='mx-auto max-w-[1400px] px-6 md:px-8 lg:px-10'>
          ...
          <p className='mx-auto mt-4 max-w-[800px] text-center text-lg text-[#40536b] md:text-xl'>
            Watch our expert troubleshooting guides for common LG appliance
            problems
          </p>
            ...
            <div className='flex items-start gap-3'>
              ...
              <div>
                ...
                <p className='mt-4 text-base leading-8 text-[#40536b] md:text-[18px]'>
                  ...
                  website (including <strong>LG</strong>,{' '}
                  <strong>Siemens</strong>, <strong>Miele</strong>,{' '}
                  <strong>AEG</strong>, <strong>Bosch</strong>,{' '}
